  ...
  return (
    <div className="flex flex-col bg-green-100 bg-opacity-40 md:w-1/2 w-5/6 h-fit shadow-md gap-20 md:gap-10">
      ...
      <form className="flex-1 flex flex-col justify-evenly items-center gap-20 md:gap-10">
        <input type="text" placeholder="Email" className="p-4 md:p-2 rounded-xl md:w-2/3 w-5/6 shadow-inner border" />
        <input type="password" placeholder="Password" className="p-4 md:p-2 rounded-xl md:w-2/3 w-5/6 shadow-inner border" />
